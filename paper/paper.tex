...
\begin{figure}[h]
  \begin{tikzpicture}[every mark/.append style={mark size=1pt}]
    ...
    \addplot table [y=mf0, x=i]{init.dat};
    \addplot table [y=mf1, x=i]{init.dat};
    \addplot table [y=mf2, x=i]{init.dat};
    \addplot table [y=mf3, x=i]{init.dat};
    \addplot table [y=mf4, x=i]{init.dat};
    \end{axis}
  \end{tikzpicture}
  \caption{TODO.}
...
\begin{figure}[h]
  \begin{tikzpicture}[every mark/.append style={mark size=1pt}]
    ...
    \addplot table [y=mf0, x=i]{late.dat};
    \addplot table [y=mf1, x=i]{late.dat};
    \addplot table [y=mf2, x=i]{late.dat};
    \addplot table [y=mf3, x=i]{late.dat};
    \addplot table [y=mf4, x=i]{late.dat};
    \end{axis}
  \end{tikzpicture}
  \caption{TODO.}
...
\begin{figure}[h]
  \begin{tikzpicture}[every mark/.append style={mark size=1pt}]
    \begin{axis}[
      xlabel=Average Market Price of Goods,
      ylabel=Iteration
    ]
    \addplot table [y=pg, x=i]{late.dat};
    \end{axis}
  \end{tikzpicture}
  \caption{TODO.}
...
\begin{figure}[h]
  \begin{tikzpicture}[every mark/.append style={mark size=1pt}]
    ...
    \addplot table [y=gini, x=i]{late.dat};
    \end{axis}
  \end{tikzpicture}
  \caption{TODO.}
  \label{plt:late-gdp}
