...
\begin{figure}[h]
  \begin{tikzpicture}[every mark/.append style={mark size=1pt}]
    ...
    \addplot [draw opacity=0.2] table [y=gdp, x=i]{late.dat};
    \addplot +[mark=none] table [y=sgdp, x=i]{smooth-gdp.dat};
    \end{axis}
  \end{tikzpicture}
